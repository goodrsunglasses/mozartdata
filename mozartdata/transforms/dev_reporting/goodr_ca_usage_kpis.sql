...
select
  ...
  , round(marketing.total_revenue, 2)                 as marketing_revenue
  , round(marketing.total_conversions, 2)             as marketing_conversions
  , round(gl_tran.total_revenue, 2)                   as gl_total_revenue
