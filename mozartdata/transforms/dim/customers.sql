SELECT
  netsuite.customer.id AS ns_cust_id,
  netsuite.customer.entityid AS ns_cust_id,
  ...
  netsuite.customer.category AS ns_cust_category,
  ...
  shopify.customer.id as sh_cust_id, --- joined on email
  shopify.customer.email as sh_cust_email
FROM
  netsuite.customer
FULL JOIN shopify.customer on shopify.customer.email = netsuite.customer.email