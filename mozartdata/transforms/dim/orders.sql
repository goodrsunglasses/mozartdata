...
SELECT
  ...
  channel,
  products_rate rate_items,
  products_amount amount_items,
  ship_rate rate_ship,
  total_quantity quantity_items,
  gross_profit profit_gross,
  profit_percent profit_percent,
  totalcostestimate cost_estimate,
  startDate date_ship_window_start,
  enddate date_ship_window_end,
  customer_id cust_id,
  trandate date_tran,
  shippingaddress_id address_ship_id,
  location,
  ns_rf_id,
  ns_if_id,
  ns_cs_id
