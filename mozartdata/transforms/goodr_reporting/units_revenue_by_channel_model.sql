...
SELECT
  month, metric,channel, family, merchandise_class, SUM(qty) as value
  FROM (SELECT month, channel,display_name,sku,family,merchandise_class, stage, 'UNITS' as metric, qty
  FROM data 
UNION ALL 
